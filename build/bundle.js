...
exports.default = [_extends({}, _App2.default, {
  routes: [_extends({}, _HomePage2.default, { // => component: HomePage　と同じ
    path: '/',
    exact: true
  }), _extends({}, _AdminsListPage2.default, {
    path: '/admins'
  }), _extends({}, _UsersListPage2.default, { // => component: UserListPage, loadData: loadDataと同じ
    path: '/users'
    ...
    _createClass(RequireAuth, [{
      ...
      value: function render() {
        switch (this.props.auth) {
          case false:
            return _react2.default.createElement(_reactRouterDom.Redirect, { to: '/' }); //SSRの場合、再描画されない・・？
          case null:
            return _react2.default.createElement(
              'div',
              null,
